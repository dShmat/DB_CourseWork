...
public class CarResourceIntTest {
    ...
    private static final Integer DEFAULT_FUEL = 1;
    private static final Integer UPDATED_FUEL = 2;
    ...
    public void getAllCars() throws Exception {
        ...
        restCarMockMvc.perform(get("/api/cars?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].fuel").value(hasItem(DEFAULT_FUEL)))
    ...
    public void getCar() throws Exception {
        ...
        restCarMockMvc.perform(get("/api/cars/{id}", car.getId()))
            ...
            .andExpect(jsonPath("$.fuel").value(DEFAULT_FUEL))
