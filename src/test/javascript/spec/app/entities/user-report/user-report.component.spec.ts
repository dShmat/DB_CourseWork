...
import { UserReportComponent } from 'app/entities/user-report/user-report.component';
...
describe('Component Tests', () => {
    describe('UserReport Management Component', () => {
        let comp: UserReportComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(UserReportComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.userReports[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
